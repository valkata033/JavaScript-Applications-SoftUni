async function lockedProfile() {
    ...
    for (const key in responseData) {
        ...
        const profileHtmlTemplate = `<div class="profile">
            ...
            <input type="text" name="user${counter}Username" value="${responseData[key].username}" disabled readonly />
            <div class="hiddenInfo" disabled readonly>
                <hr>
                <label>Email:</label>
                <input type="email" name="user${counter}Email" value="${responseData[key].email}"/>
                <label>Age:</label>
                <input type="email" name="user${counter}Age" value="${responseData[key].age}"/>
            </div>

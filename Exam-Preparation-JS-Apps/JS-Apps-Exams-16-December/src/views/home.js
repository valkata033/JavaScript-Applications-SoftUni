...
import { getAll } from '../api/theaterService.js';

const homeTemplate = (theaters, user) => html`
<section class="welcomePage">
    ...
    <div id="events">
        ...
        <div class="theaters-container">
            ...
            ${theaters.length > 0
                ? theaters.map(x => theatreTemplate(x, user))
...
const theatreTemplate = (theater, user) => html`
<div class="eventsInfo">
    ...
    <div class="info">
        ...
        <div class="info-buttons">
            <!-- ${user
                ? html`<a class="btn-details" href="/details/${theater._id}">Details</a>`
                : nothing 
            } -->
...
export const homeView = async (ctx) => {
    ...
    ctx.render(homeTemplate(theaters, ctx.user));
}